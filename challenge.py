    ...
    while True:
        ...
        while running:
            try:
                ...
                if way_back and green_points:
                    print("Green Points", green_points)
                    print("Relative Position", relative_green_points_positions)
                    for (point, position) in zip(green_points, relative_green_points_positions):
                        if position == "left":
                        ...
                        robot.motor_left_1.run_for_rotations(6 * 4 * 6, 100, False)
                        robot.motor_left_2.run_for_rotations(6 * 4 * 6, 100, False)
                        robot.motor_right_1.run_for_rotations(6 * 4 * 6, 100, False)
                        robot.motor_right_2.run_for_rotations(6 * 4 * 6, 100, True)
                ...
                if last_dist_front and robot.dist_front:
                    if last_dist_front < 7 and robot.dist_front < 7:
                        print("turning")
                        robot.motor_left_1.run_for_rotations(7*2, 100, False)
                        robot.motor_left_2.run_for_rotations(7*2, 100, False)
                        robot.motor_right_1.run_for_rotations(7*2, 100, False)
                        robot.motor_right_2.run_for_rotations(7*2, 100, True)
                        way_back = True
